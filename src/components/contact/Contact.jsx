        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="first-and-lastname">
            <div className="input-container">
              ...
              {errors.firstName && (
                <p className="error-msg">Please enter a first name</p>
              )}
            </div>
            ...
            <div className="input-container">
              ...
              {errors.lastName && (
                <p className="error-msg">Please enter a last name</p>
              )}
            </div>
          </div>
          ...
          <div className="input-container">
            ...
            <textarea
              style={{
                border: errors.message ? "1px solid red" : "1px solid #D0D5DD",
              }}
              name="message"
              id="message"
            ...
            />
            {errors.message && (
              <p className="error-msg">Please enter a message</p>
            )}
          </div>
